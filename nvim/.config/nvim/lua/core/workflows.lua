...
-- navigate to vault
vim.keymap.set("n", "<leader>oo", ":cd " .. vim.fn.expand("~/personal/secondbrain") .."<cr>")
--
...
vim.keymap.set("n", "<leader>os", ":Telescope find_files search_dirs={\"" .. vim.fn.expand("~/personal/secondbrain") .. "\"}<cr>")
vim.keymap.set("n", "<leader>oz", ":Telescope live_grep search_dirs={\"" .. vim.fn.expand("~/personal/secondbrain") .. "\"}<cr>")
--
